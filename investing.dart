...
class InvestingRoute extends StatefulWidget {
  final title;
  final data;
  final stocks;
  final quant;
  ...
  InvestingRoute(this.title, this.data, this.stocks, this.quant, this.subData);

  @override
  InvestingRouteState createState() =>
      new InvestingRouteState(title, data, stocks, quant, subData);
}

class InvestingRouteState extends State<InvestingRoute> {
  final title;
  final data;
  final stocks;
  final quant;
  ...
  InvestingRouteState(
      this.title, this.data, this.stocks, this.quant, this.subData);
                ...
                child: new Column(
                  children: <Widget>[
                    ...
                    new Container(
                      ...
                      child: new Sparkline(
                        data: invSelNum == -1 ? data : subData[invSelNum],
                      ...
                      child: invSel == "all"
                          ...
                          child: new Row(children: <Widget>[
                            Expanded(
                              flex: 1,
                              child: Text(
                                "Open \$" + openAll.toStringAsFixed(2),
                                ...
                                children: <Widget>[
                                  ...
                                  _isLoading
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      var totalD = priceD * quan;
                                      //total = total + totalD;
                                      //totalInv = totalInv + totalD;
                                      var totalS =
                                      totalD.toStringAsFixed(2);
