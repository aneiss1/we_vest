...
class TradingRoute extends StatefulWidget {
  final title;
  final data;
  final stocks;
  final quant;
  ...
  TradingRoute(this.title, this.data, this.stocks, this.quant, this.subData);

  @override
  TradingRouteState createState() =>
      new TradingRouteState(title, data, stocks, quant, subData);
}

class TradingRouteState extends State<TradingRoute> {
  final title;
  final data;
  final stocks;
  final quant;
